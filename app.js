...
// Connect to MongoDB
mongoose.connect('mongodb+srv://ninja54:Lalit123@cluster0.96z82.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
...
app.get("/books/loaned",
    middleware.LogIn, //TODO: call a function from middleware object to check if logged in (use the middleware object imported)
